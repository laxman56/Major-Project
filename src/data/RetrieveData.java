...
public class RetrieveData {
	...
	private static final String SEARCH_TERM= "-22.912214,-43.230182";
			...
			for (int queryNumber=0;queryNumber < MAX_QUERIES; queryNumber++)
			{
				...
				for (Status s: r.getTweets())				// Loop through all the tweets...
				{
					...
					System.out.printf("At %s, @%-20s said:  %s\n",
									  ...
									  cleanText(s.getText()));
					PrintWriter out = new PrintWriter(new FileWriter("/home/laxman/Development/data/output.txt",true));
